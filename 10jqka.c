...
//http://yuanchuang.10jqka.com.cn/jhqb_list/ 同花顺机会情报
int jhqb( char *input_html, struct NewsInfo *s )
{
	...
	iStart=indexOf(input_html,"\"list-con\"");
	...
	for( n=0;n<50; n++) //网页上一页有50条数据
	{
		...
		if( iStart != -1)
		{
			...
			strcpy( s[n].articleauthor, "同花顺机会情报" );
			strcpy( s[n].sourcename, "同花顺机会情报" );
