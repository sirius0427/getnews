...
int stockssgs( char *input_html, struct NewsInfo *s )
{
	...
	iStart=indexOf(input_html,"list-main");
	...
	for( n=0;n<100; n++) //网页上一页有50条数据
	{
		...
		if( iStart != -1)
		{
			...
			strcpy( s[n].articleauthor, "金融界上市公司" );
			strcpy( s[n].sourcename, "金融界上市公司" );
...
int stockgszx( char *input_html, struct NewsInfo *s )
{
	char tmpstr[1024],strDate[9];
	char change[13],rate[13],secuFullcode[10],secuName[13];
	int iStart=0,iEnd;
	...
	for( n=0;n<100; n++) //网页上一页有50条数据
	{
		...
		if( iStart != -1)
		{
			...
			strcpy( s[n].articleauthor, "金融界股市资讯" );
			strcpy( s[n].sourcename, "金融界股市资讯" );
...
int gnjj( char *input_html, struct NewsInfo *s )
{
	char tmpstr[1024],strDate[9];
	char change[13],rate[13],secuFullcode[10],secuName[13];
	int iStart=0,iEnd;
	...
	for( n=0;n<100; n++) //网页上一页有50条数据
	{
		...
		if( iStart != -1)
		{
			...
			strcpy( s[n].articleauthor, "金融界行业掘金" );
			strcpy( s[n].sourcename, "金融界行业掘金" );
...
int hyxw( char *input_html, struct NewsInfo *s )
{
	char tmpstr[1024],strDate[9];
	char change[13],rate[13],secuFullcode[10],secuName[13];
	int iStart=0,iEnd;
	...
	for( n=0;n<100; n++) //网页上一页有50条数据
	{
		...
		if( iStart != -1)
		{
			...
			strcpy( s[n].articleauthor, "金融界行业新闻" );
			strcpy( s[n].sourcename, "金融界行业新闻" );
