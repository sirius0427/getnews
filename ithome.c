...
//http://www.ithome.com.cn IT之家 
int ithome( char *input_html, struct NewsInfo *s )
{
	...
	iStart=indexOf(input_html,"\"cate_list\"");
	...
	for( n=0;n<50; n++) //网页上一页有50条数据
	{
		...
		if( iStart != -1)
		{
			...
			strcpy( s[n].articleauthor, "IT之家" );
			strcpy( s[n].sourcename, "IT之家" );
